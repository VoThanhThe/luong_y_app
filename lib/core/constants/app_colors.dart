...
class AppColors {
  static Color primaryColor = const Color(0xff16A6AF);
  static Color primaryDarkColor = const Color(0xff087F8C);
  static Color primaryLightColor = const Color(0xff68C9D0);
